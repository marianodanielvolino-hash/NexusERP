        ...
        <div style={{ display: 'flex', minHeight: '100vh', alignItems: 'center', justifyContent: 'center', background: 'var(--bg)', position: 'relative', overflow: 'hidden' }}>
            ...
            <div className="glass-panel" style={{ width: '100%', maxWidth: '420px', padding: '3rem', borderRadius: '16px', zIndex: 1, boxShadow: '0 20px 40px rgba(0,0,0,0.5)' }}>
                <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
                    ...
                    <h1 style={{ fontFamily: 'Syne', fontSize: '1.5rem', color: 'white', letterSpacing: '1px' }}>Nueva Contraseña</h1>
                    <p style={{ fontSize: '0.8rem', color: 'var(--texto3)', marginTop: '4px', textTransform: 'uppercase', letterSpacing: '2px' }}>Actualiza tus credenciales</p>
                </div>
                ...
                <form onSubmit={handleResetPassword} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
                    <div>
                        <label style={{ display: 'block', fontSize: '0.75rem', color: 'var(--texto3)', marginBottom: '0.4rem', textTransform: 'uppercase', letterSpacing: '1px' }}>Nueva Contraseña</label>
                        <input
                            type="password"
                            required
                            value={password}
